 ...
 */
contract USDTBridgeMainnet is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address _usdt, uint256 _requiredSignatures) {
        ...
        minTransferAmount = 10 * 10**18;     // $10 minimum
        maxTransferAmount = 50000 * 10**18;  // $50,000 maximum
        dailyLimit = 500000 * 10**18;        // $500K per address/day
    ...
    function withdrawFees(address recipient) external onlyOwner {
        ...
        require(usdt.transfer(recipient, fees), "Transfer failed");
    }
