...
async function main() {
    ...
    const MintableBTCBR = await ethers.getContractFactory("MintableBTCBR", wallet);
    ...
    console.log("\n🔍 Verification:");
    console.log("  Deployer Balance:", ethers.formatEther(deployerBalance), "BTCBR");
    console.log("  Validator Balance:", ethers.formatEther(validatorBalance), "BTCBR");
    ...
    console.log("\n" + "=".repeat(70));
    console.log("💾 Deployment info saved to: docs/deployment-logs/btcbr-token-deployment.json");
    ...
    console.log("  Deployer Balance:", ethers.formatEther(deployerBalance), "BTCBR");
    console.log("  Validator Balance:", ethers.formatEther(validatorBalance), "BTCBR");
    console.log("  Explorer:", `https://explorer.xaheen.org/address/${btcbrAddr}`);
    ...
    console.log("  To deploy at specific address, need to embed in genesis file.");
