 ...
 * Works with existing Xaheen chain gas!
 */
...
async function main() {
    ...
    console.log("\n🔧 CONFIGURATION:");
    console.log("  BTCBR on Xaheen:", BTCBR_XAHEEN);
    console.log("  XHN on Xaheen:", XHN_XAHEEN);
    ...
    console.log("  npx hardhat run scripts/deploy-all-bridges-bsc.js --network bsc");

    console.log("\n✅ XAHEEN SIDE COMPLETE!");
    console.log("  Both BTCBR and XHN bridges ready on Xaheen");
