...
async function main() {
    ...
    console.log("\n💰 Starting Balance:", ethers.formatEther(initialBalance), "BNB");
    ...
    console.log("  💰 Balance after BTCBR bridge:", ethers.formatEther(currentBalance), "BNB");
    ...
    console.log("  💰 Balance after XHN bridge:", ethers.formatEther(currentBalance), "BNB");
    ...
    currentBalance = await ethers.provider.getBalance(deployer.address);
    console.log("\n💰 Balance before liquidity:", ethers.formatEther(currentBalance), "BNB");

    // Leave 0.005 BNB for final gas
    const remainingForLiquidity = currentBalance - ethers.parseEther("0.005");
    console.log("  Available for liquidity:", ethers.formatEther(remainingForLiquidity), "BNB");
    ...
    console.log("\n🥞 PANCAKESWAP STATUS:");
    console.log("  ✅ BTCBR: https://pancakeswap.finance/swap?outputCurrency=" + BTCBR_BSC + "&chain=bsc");
    console.log("     Liquidity: $106 USD");
    console.log("\n  ✅ XHN: https://pancakeswap.finance/swap?outputCurrency=" + XHN_BSC + "&chain=bsc");
    console.log("     Liquidity: ~$" + Math.floor(parseFloat(ethers.formatEther(remainingForLiquidity)) * 720) + " USD");
    ...
    console.log("  2. Test bridge: Xaheen → BSC");
    console.log("  3. Test bridge: BSC → Xaheen");
