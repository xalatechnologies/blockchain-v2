...
async function main() {
  ...
  const wxhtCode = await provider.getCode(ADDRESSES.WNOR);
  if (wxhtCode !== "0x") {
    ...
    console.log("\nWNOR Balance:", Number(formatted).toLocaleString(), "WNOR");
    console.log("Target: 500,000,000 WNOR");
    console.log(
      "Progress:",
      ((Number(formatted) / 500000000) * 100).toFixed(2),
      "%"
    );
  }
}
