...
async function main() {
    ...
    await (await pair.initialize(BTCBR, WXHT, ethers.ZeroAddress)).wait();
    ...
    await (await pairContract.mint(deployer.address, { gasLimit: 500000 })).wait();
    ...
    console.log("\n✅ You now have a working DEX on Xaheen!");
}
