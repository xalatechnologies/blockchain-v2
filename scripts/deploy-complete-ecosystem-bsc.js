...
async function main() {
  ...
  if (balance < requiredBNB) {
    throw new Error(
      `❌ Insufficient balance. Need at least 2.5 BNB, you have ${ethers.formatEther(
        balance
      )} BNB`
    );
  }
  ...
  console.log(
    `   Total Supply: ${ethers.formatEther(await btcbr.totalSupply())} BTCBR`
  );
  ...
  console.log(
    `   Total Supply: ${ethers.formatEther(await xhn.totalSupply())} XHN`
  );
  ...
  console.log(
    `   Initial price: 1 BNB = ${
      parseFloat(ethers.formatEther(btcbrAmount)) /
      parseFloat(ethers.formatEther(bnbForBtcbr))
    } BTCBR`
  );
  ...
  console.log(
    `   Initial price: 1 BNB = ${
      ...
      parseFloat(ethers.formatEther(bnbForXhn))
    } XHN`
  );
  ...
  console.log(
    "  BTCBR Received:",
    ethers.formatEther(totalBtcbrReceived),
    "BTCBR"
  );
  ...
  console.log("\n🌐 LIVE URLS:");
  console.log(
    "  PancakeSwap BTCBR: https://pancakeswap.finance/swap?outputCurrency=" +
      btcbrAddress
  );
  console.log(
    "  PancakeSwap XHN: https://pancakeswap.finance/swap?outputCurrency=" +
      xhnAddress
  );
  console.log(
    "  DexScreener BNB/BTCBR: https://dexscreener.com/bsc/" + bnbBtcbrPair
  );
  console.log(
    "  DexScreener BNB/XHN: https://dexscreener.com/bsc/" + bnbXhnPair
  );
