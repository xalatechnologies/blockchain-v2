...
async function main() {
  console.log("\n💧 ADDING INITIAL NOR/USDT LIQUIDITY");
  ...
  const WNOR_ADDRESS = dexDeployment.contracts.WNOR;
  ...
  const pairAddress = await factory.getPair(USDT_ADDRESS, WNOR_ADDRESS);
  ...
  const pricePerNOR = (Number(usdtReserve) / Number(xhtReserve)).toFixed(10);
  console.log("\n💹 CURRENT PRICE:");
  console.log("  1 NOR =", pricePerNOR, "USDT");
