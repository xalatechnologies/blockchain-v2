 ...
 *
 * Deploys:
 * 1. XaheenRouter - Dual-mode router (LP + hot inventory)
...
async function main() {
    ...
    const chainConfig = {
        56: {
            ...
            xhtToken: process.env.XHT_BSC_ADDRESS || "0x0000000000000000000000000000000000000000",
        ...
        137: {
            ...
            xhtToken: process.env.XHT_POLYGON_ADDRESS || "0x0000000000000000000000000000000000000000",
        ...
        1: {
            ...
            xhtToken: process.env.XHT_ETH_ADDRESS || "0x0000000000000000000000000000000000000000",
    ...
    if (!config) {
        throw new Error(`Unsupported chain ID: ${chainId}. Supported: 56 (BSC), 137 (Polygon), 1 (Ethereum)`);
    }

    console.log("📋 Configuration:");
    console.log("   Network:", config.name);
    console.log("   DEX Router:", config.dexRouter);
    console.log("   XHT Token:", config.xhtToken);
    console.log();

    // PriceAuthority signer from Xaheen hub
    const PRICE_AUTHORITY_SIGNER = process.env.PRICE_AUTHORITY_SIGNER || deployer.address;
    ...
    console.log("🔀 Deploying XaheenRouter...");
    ...
    console.log("✅ XaheenRouter deployed at:", xaheenRouterAddress);
    console.log();
    ...
    console.log("💵 Adding payment tokens to XaheenRouter...");
    ...
    console.log("2. Register public LPs (if available): xaheenRouter.registerPublicLP()");
    console.log("3. Configure relayer to monitor Fill events from SettlementInbox");
    console.log("4. Test with small trades");
    console.log();

    console.log("💾 Save these addresses:");
    console.log(`XAHEEN_ROUTER_${config.name.toUpperCase()}_ADDRESS=${xaheenRouterAddress}`);
    console.log(`SETTLEMENT_INBOX_${config.name.toUpperCase()}_ADDRESS=${settlementInboxAddress}`);
}
