...
const CONTRACTS = {
  ...
  // NOR Token (Native governance & gas - NOT XHT!)
...
// 3. NOR Token - Native token (NOT XHT!)
...
console.log(`   Symbol: NOR (NOT XHT)`);
...
console.log(`   NoorSwap Factory: ${CONTRACTS.NOORSWAP_FACTORY}`);
console.log(`   NoorSwap Router:  ${CONTRACTS.NOORSWAP_ROUTER}`);
...
// Write genesis file
const outputPath = 'data/genesis-noor-ultimate.json';
...
console.log(`   Network: Noor Chain (نور - "Light")`);
console.log(`   Native Token: NOR (NOT XHT)`);
...
console.log('   5. Deploy NoorSwap DEX');
