...
async function main() {
    ...
    // Get contracts
    const pancakeRouter = await ethers.getContractAt("XaheenDEXRouter", PANCAKE_ROUTER);
    ...
    console.log("\n📊 LIQUIDITY TO ADD:");
    console.log("  WBNB/BTCBR: ", ethers.formatEther(halfBnb), "BNB +", ethers.formatEther(btcbrAmount), "BTCBR");
    console.log("  WBNB/XHN: ", ethers.formatEther(halfBnb), "BNB +", ethers.formatEther(xhnAmount), "XHN");
