...
async function main() {
  ...
  console.log(
    "💰 NOR Token Balance:",
    ethers.formatUnits(norBalance, 24),
    "NOR\n"
  );
  ...
  const addLiqTx1 = await router.addLiquidity(
    ...
    norAmount1,
    usdtAmount1,
    norAmount1.mul(95n).div(100n), // 5% slippage
    usdtAmount1.mul(95n).div(100n),
    deployer.address,
    deadline
  );
  ...
  const norReserve1 =
    token0.toLowerCase() === NOR_TOKEN.toLowerCase() ? reserve0 : reserve1;
  const usdtReserve1 =
    token0.toLowerCase() === NOR_TOKEN.toLowerCase() ? reserve1 : reserve0;
  ...
  const addLiqTx2 = await router.addLiquidity(
    ...
    norAmount2,
    bnbAmount2,
    norAmount2.mul(95n).div(100n),
    bnbAmount2.mul(95n).div(100n),
    deployer.address,
    deadline
  );
  ...
  const norReserve2 =
    token0_p2.toLowerCase() === NOR_TOKEN.toLowerCase()
      ? reserve0_p2
      : reserve1_p2;
  const bnbReserve2 =
    token0_p2.toLowerCase() === NOR_TOKEN.toLowerCase()
  ...
  const addLiqTx3 = await router.addLiquidity(
    ...
    norAmount3,
    ethAmount3,
    norAmount3.mul(95n).div(100n),
    ethAmount3.mul(95n).div(100n),
    deployer.address,
    deadline
  );
  ...
  const norReserve3 =
    token0_p3.toLowerCase() === NOR_TOKEN.toLowerCase()
      ? reserve0_p3
      : reserve1_p3;
  const ethReserve3 =
    token0_p3.toLowerCase() === NOR_TOKEN.toLowerCase()
  ...
  const addLiqTx4 = await router.addLiquidity(
    ...
    norAmount4,
    dirhamatAmount4,
    norAmount4.mul(95n).div(100n),
    dirhamatAmount4.mul(95n).div(100n),
    deployer.address,
    deadline
  );
  ...
  const norReserve4 =
    token0_p4.toLowerCase() === NOR_TOKEN.toLowerCase()
      ? reserve0_p4
      : reserve1_p4;
  ...
  const addLiqTx5 = await router.addLiquidity(
    ...
    dirhamatAmount5,
    usdtAmount5,
    dirhamatAmount5.mul(95n).div(100n),
    usdtAmount5.mul(95n).div(100n),
    deployer.address,
    deadline
  );
