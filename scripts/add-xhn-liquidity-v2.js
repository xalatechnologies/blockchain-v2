...
async function main() {
  console.log("🚀 Adding NOR/XHN Liquidity (V2 - New Deployment)");
  ...
  // LATEST contract addresses from fixed deployment (Nor Chain)
  ...
  const WNOR_ADDRESS = "0x2AfF9B4999f587090840f4fD8F85A7EE643947Ee";
  const XHN_ADDRESS = "0xD4567cD447068aaD470431746592f261Fae92bAa"; // ✅ Deployed to Nor Chain
  ...
  console.log("\n" + "=".repeat(70));
  console.log("STEP 1: Create NOR/XHN Pair");
  console.log("=".repeat(70));
  ...
  console.log("  Initial price: 1 NOR = 100 XHN (or 1 XHN = 0.01 NOR)");
  ...
  const addLiquidityTx = await router.addLiquidityNOR(
    ...
    (xhtAmount * (100n - slippage)) / 100n, // Min NOR
    deployer.address,
    deadline,
    { value: xhtAmount }
  );
  ...
  console.log("\n📝 Contract Addresses:");
  console.log("  NOR/XHN Pair:", pairAddress);
