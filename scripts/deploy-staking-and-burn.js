...
async function main() {
    console.log("\n💰 DEPLOYING XHT STAKING AND BURN MECHANISM");
    ...
    // 1. Deploy XHTStaking
    console.log("\n" + "=".repeat(70));
    console.log("📝 DEPLOYING XHT STAKING CONTRACT");
    console.log("=".repeat(70));

    const XHTStaking = await ethers.getContractFactory("XHTStaking", wallet);
    console.log("\n⏳ Deploying XHTStaking...");

    const stakingContract = await XHTStaking.deploy();
    await stakingContract.waitForDeployment();
    const stakingAddr = await stakingContract.getAddress();

    console.log("✅ XHTStaking deployed:", stakingAddr);
    ...
    console.log("\n🔍 Verification:");
    console.log("  Total Staked:", ethers.formatEther(totalStaked), "XHT");
    ...
    console.log("\n" + "=".repeat(70));
    console.log("📝 DEPLOYING XHT BURN MECHANISM");
    console.log("=".repeat(70));

    const XHTBurnMechanism = await ethers.getContractFactory("XHTBurnMechanism", wallet);
    console.log("\n⏳ Deploying XHTBurnMechanism...");

    const burnContract = await XHTBurnMechanism.deploy();
    await burnContract.waitForDeployment();
    const burnAddr = await burnContract.getAddress();

    console.log("✅ XHTBurnMechanism deployed:", burnAddr);
    ...
    console.log("\n🔍 Verification:");
    console.log("  Total Burned:", ethers.formatEther(totalBurned), "XHT");
    console.log("  Current Supply:", ethers.formatEther(currentSupply), "XHT");
    ...
    console.log("\n" + "=".repeat(70));
    console.log("💾 Deployment info saved to: docs/deployment-logs/staking-burn-deployment.json");
    ...
    console.log("  Explorer:", `https://explorer.xaheen.org/address/${stakingAddr}`);

    console.log("\n🔥 Burn Mechanism:");
    console.log("  Address:", burnAddr);
    console.log("  Initial Supply:", ethers.formatEther(currentSupply), "XHT");
    console.log("  Minimum Floor: 100,000,000 XHT");
    console.log("  Gas Burn:", gasBurnPercentage.toString(), "%");
    console.log("  Validator Burn:", validatorBurnPercentage.toString(), "%");
    console.log("  Bridge Burn:", bridgeBurnPercentage.toString(), "%");
    ...
    console.log("\n💡 NEXT STEPS:");
    console.log("1. Deploy XHTRevenue contract with these addresses");
