...
/**
 * Deploy XHN (Xaheen Network Token)
 *
...
async function main() {
    console.log("🚀 Deploying XHN (Xaheen Network Token)");
    ...
    console.log("\n  Allocation:");
    console.log("    ✅ Initial Supply: 100M (10%) - Deployed to", deployer.address);
    ...
    console.log("\n📝 NEXT STEPS:");
    console.log("  1. Create XHT/XHN liquidity pair");
    console.log("  2. Add initial liquidity (e.g., 1000 XHT + 100,000 XHN)");
    ...
    console.log("  ✅ Independent value proposition from XHT/BTCBR");
