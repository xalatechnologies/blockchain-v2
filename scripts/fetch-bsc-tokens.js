 ...
 * for embedding in Xaheen Chain genesis
 */
...
async function main() {
    ...
    // Print summary
    console.log("\n📊 SUMMARY:");
    console.log(`\nTokens fetched: ${Object.keys(tokenData).length} / ${Object.keys(TOKENS).length}`);
    ...
    console.log("3. This will create genesis-xaheen-v2.json with all tokens embedded");
